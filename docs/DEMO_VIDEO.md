# Demo Video Script & Timestamps (Level 6 MVP)
...
- **Narration:** "Welcome to the Level 6 Midnight Sealed-Bid Marketplace. Today, we'll demonstrate a fully decentralized, privacy-preserving auction system. First, we connect our Lace wallet on the Midnight Preprod network, utilizing our custom adapter that seamlessly handles unshielded tokens."
