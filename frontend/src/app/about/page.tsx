...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-20 relative">
      ...
      {/* Background Ambience */}
      <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-gradient-to-tr from-zinc-500/10 via-zinc-500/10 to-transparent rounded-full blur-[140px] pointer-events-none -z-10" />

      {/* HERO SECTION */}
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center pt-6">
        <div className="lg:col-span-7 space-y-6 text-left">
          
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-zinc-500/10 border border-zinc-700/30 text-zinc-400 text-xs font-mono tracking-wide">
          ...
          <h1 className="text-4xl sm:text-6xl font-black text-white tracking-tight leading-[1.1]">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-300 via-zinc-400 to-zinc-400">
              Institutional Dark Pool
            </span> DEX.
          </h1>

          <p className="text-base sm:text-lg text-zinc-300 leading-relaxed max-w-2xl font-light">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <Link
              href="/trade"
              className="px-6 py-3.5 rounded-xl bg-gradient-to-r from-zinc-500 to-zinc-600 hover:from-zinc-400 hover:to-zinc-500 text-white font-bold text-sm flex items-center gap-2 shadow-lg shadow-zinc-700/20 hover:shadow-zinc-700/40 transition-all duration-300 group"
            >
            ...
            <Link
              href="/docs"
              className="px-6 py-3.5 rounded-xl bg-zinc-900/80 hover:bg-zinc-800 border border-white/10 hover:border-white/20 text-slate-200 font-semibold text-sm flex items-center gap-2 transition-all"
            >
          ...
          <div className="grid grid-cols-3 gap-4 pt-4 border-t border-white/10 text-left font-mono">
            <div>
              ...
              <p className="text-[11px] text-zinc-400 uppercase">MEV Leakage</p>
            </div>
            <div>
              <p className="text-2xl sm:text-3xl font-bold text-zinc-400">128 B</p>
              <p className="text-[11px] text-zinc-400 uppercase">Proof Footprint</p>
            </div>
            <div>
              <p className="text-2xl sm:text-3xl font-bold text-zinc-400">100%</p>
              <p className="text-[11px] text-zinc-400 uppercase">Client-Side ZK</p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-5 flex flex-col items-center justify-center relative">
          <div className="w-full h-[420px] rounded-3xl bg-zinc-950/60 border border-zinc-700/20 backdrop-blur-2xl shadow-[0_0_50px_rgba(161,161,170,0.15)] overflow-hidden relative group">
            <div className="absolute top-4 left-4 z-10 text-[11px] font-mono text-zinc-400 flex items-center gap-2">
      ...
      <section className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl bg-zinc-900/60 border border-white/10 hover:border-rose-500/40 transition-all duration-300 space-y-3 text-left group">
          ...
          <div className="p-6 rounded-2xl bg-zinc-900/60 border border-white/10 hover:border-zinc-600/40 transition-all duration-300 space-y-3 text-left group">
            <div className="w-12 h-12 rounded-xl bg-zinc-500/10 border border-zinc-600/20 flex items-center justify-center text-zinc-400 group-hover:scale-110 transition-transform">
          ...
          <div className="p-6 rounded-2xl bg-zinc-900/60 border border-white/10 hover:border-zinc-700/40 transition-all duration-300 space-y-3 text-left group">
            <div className="w-12 h-12 rounded-xl bg-zinc-500/10 border border-zinc-700/20 flex items-center justify-center text-zinc-400 group-hover:scale-110 transition-transform">
      ...
      <section className="space-y-10">
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-zinc-500/10 border border-zinc-700/30 text-zinc-400 text-xs font-mono">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Pillar 1 */}
          <div className="p-7 rounded-2xl bg-gradient-to-b from-zinc-900/90 to-zinc-950/90 border border-zinc-700/30 hover:border-zinc-600/60 transition-all duration-300 space-y-4 text-left relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-28 h-28 bg-zinc-500/10 rounded-full blur-2xl group-hover:bg-zinc-500/20 transition-all" />
            <div className="w-12 h-12 rounded-xl bg-zinc-500/20 border border-zinc-700/30 flex items-center justify-center text-zinc-400">
            ...
            <div className="pt-2 flex items-center gap-1.5 text-zinc-400 text-[11px] font-mono">
          ...
          {/* Pillar 5 */}
          <div className="p-7 rounded-2xl bg-gradient-to-b from-zinc-900/90 to-zinc-950/90 border border-zinc-600/30 hover:border-indigo-400/60 transition-all duration-300 space-y-4 text-left relative overflow-hidden group">
      ...
      <section className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 bg-zinc-900 p-1 rounded-xl border border-white/10 font-mono text-xs">
            <button
              onClick={() => setActiveTab('comparison')}
              className={`px-3 py-1.5 rounded-lg transition-all ${activeTab === 'comparison' ? 'bg-zinc-500 text-white font-bold' : 'text-zinc-400 hover:text-white'}`}
            >
              Protocol Matrix
            </button>
            <button
              onClick={() => setActiveTab('compliance')}
              className={`px-3 py-1.5 rounded-lg transition-all ${activeTab === 'compliance' ? 'bg-zinc-500 text-white font-bold' : 'text-zinc-400 hover:text-white'}`}
            >
              Compliance Vector
            </button>
          </div>
        ...
        {activeTab === 'comparison' && (
          <div className="overflow-x-auto rounded-2xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl">
            <table className="w-full text-left text-xs font-mono">
              <thead className="bg-zinc-950/80 text-zinc-400 border-b border-white/10">
                <tr>
                  ...
                  <th className="p-4 uppercase tracking-wider text-zinc-400 bg-zinc-500/10">Midnight Dark Pool</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5 text-zinc-300">
                <tr className="hover:bg-white/[0.02]">
                  <td className="p-4 font-bold text-white">Privacy Primitive</td>
                  <td className="p-4 text-zinc-400">2-step hash & reveal</td>
                  <td className="p-4 text-zinc-400">Intel SGX / hardware</td>
                  <td className="p-4 text-zinc-400">Fully Homomorphic Enc.</td>
                  <td className="p-4 text-zinc-300 font-bold bg-zinc-500/5">Compact zk-SNARKs</td>
                </tr>
                <tr className="hover:bg-white/[0.02]">
                  ...
                  <td className="p-4 text-zinc-400">Preserved</td>
                  <td className="p-4 text-zinc-400">Preserved</td>
                  <td className="p-4 text-zinc-300 font-bold bg-zinc-500/5 flex items-center gap-1.5"><CheckCircle2 className="w-3.5 h-3.5 text-zinc-400" /> Preserved + Selective</td>
                </tr>
                <tr className="hover:bg-white/[0.02]">
                  <td className="p-4 font-bold text-white">Free Option Exploit</td>
                  <td className="p-4 text-rose-400">Vulnerable (Abandonment)</td>
                  <td className="p-4 text-zinc-400">Protected</td>
                  <td className="p-4 text-zinc-400">Protected</td>
                  <td className="p-4 text-zinc-300 font-bold bg-zinc-500/5">Protected (Atomic ZK)</td>
                </tr>
                <tr className="hover:bg-white/[0.02]">
                  <td className="p-4 font-bold text-white">Compute Latency</td>
                  <td className="p-4 text-zinc-400">Block time</td>
                  <td className="p-4 text-zinc-400">Milliseconds</td>
                  <td className="p-4 text-rose-400">Very Slow (seconds/mins)</td>
                  <td className="p-4 text-zinc-300 font-bold bg-zinc-500/5">Client &lt;1.8s · Verifier 2ms</td>
                </tr>
                <tr className="hover:bg-white/[0.02]">
                  ...
                  <td className="p-4 text-rose-400">Public Gas Linkage</td>
                  <td className="p-4 text-zinc-300 font-bold bg-zinc-500/5">Shielded DUST Token</td>
                </tr>
                <tr className="hover:bg-white/[0.02]">
                  <td className="p-4 font-bold text-white">Regulatory Auditability</td>
                  <td className="p-4 text-zinc-400">All-or-Nothing</td>
                  <td className="p-4 text-zinc-400">Enclave dependent</td>
                  <td className="p-4 text-zinc-400">Complex ZK-FHE circuits</td>
                  <td className="p-4 text-zinc-300 font-bold bg-zinc-500/5">Viewing Keys (Dual-State)</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        {activeTab === 'compliance' && (
          <div className="p-8 rounded-2xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl space-y-4 text-left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
              <div className="p-4 rounded-xl bg-zinc-950/60 border border-white/5 space-y-1">
                <span className="text-xs font-bold text-zinc-400 font-mono">1. Verifiable Execution</span>
                <p className="text-xs text-zinc-400">Generate Merkle inclusion proofs verifying trade execution without disclosing trading logic.</p>
              </div>
              <div className="p-4 rounded-xl bg-zinc-950/60 border border-white/5 space-y-1">
                <span className="text-xs font-bold text-zinc-400 font-mono">2. Tax & PnL Export</span>
                <p className="text-xs text-zinc-400">Export zero-knowledge cost-basis certificates directly to tax auditors without publishing public ledgers.</p>
              </div>
              <div className="p-4 rounded-xl bg-zinc-950/60 border border-white/5 space-y-1">
                <span className="text-xs font-bold text-zinc-400 font-mono">3. Clean Flow Provenance</span>
                <p className="text-xs text-zinc-400">Prove funds are non-sanctioned without linking identity to individual dark order IDs.</p>
              </div>
            </div>
          </div>
        )}
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        <div className="lg:col-span-5 p-8 rounded-2xl bg-zinc-900/60 border border-white/10 space-y-4 text-left">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-zinc-500/10 border border-zinc-700/30 text-zinc-400 text-xs font-mono">
          ...
          <div className="pt-2 flex flex-col gap-2 font-mono text-xs text-zinc-400">
            <div className="flex items-center justify-between py-1.5 border-b border-white/5">
              ...
              <a href="https://github.com/efekrbas" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:underline flex items-center gap-1">
            ...
            <div className="flex items-center justify-between py-1.5">
              ...
              <span className="text-zinc-400">Midnight Preprod & Preview</span>
            </div>
          </div>
        </div>

        <div className="lg:col-span-7 p-8 rounded-2xl bg-zinc-900/60 border border-white/10 space-y-6 text-left">
          <h3 className="text-2xl font-bold text-white">Strategic Protocol Roadmap</h3>
          <div className="space-y-4 font-mono text-xs">
            <div className="p-3.5 rounded-xl bg-zinc-500/10 border border-zinc-700/30 flex items-start gap-3">
            ...
            <div className="p-3.5 rounded-xl bg-zinc-500/10 border border-zinc-700/30 flex items-start gap-3">
              <span className="px-2 py-0.5 rounded bg-zinc-500/20 text-zinc-300 text-[10px] font-bold uppercase mt-0.5">In Progress</span>
              <div>
                <p className="font-bold text-white">Phase 2: Automated Relayer Batching & Viewing Key Portal</p>
                <p className="text-zinc-400 text-[11px] mt-0.5">Standardizing selective disclosure viewing key exports and multi-party batch matching engine integration.</p>
              </div>
            </div>

            <div className="p-3.5 rounded-xl bg-zinc-950/60 border border-white/5 flex items-start gap-3 opacity-75">
              <span className="px-2 py-0.5 rounded bg-zinc-800 text-zinc-400 text-[10px] font-bold uppercase mt-0.5">Upcoming</span>
              <div>
                <p className="font-bold text-white">Phase 3: Formal Verification & Mainnet Institutional Sandbox</p>
                <p className="text-zinc-400 text-[11px] mt-0.5">Comprehensive third-party circuit audits, Cardano bridge cross-collateralization, and mainnet launch.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* CTA FOOTER */}
      <section className="p-10 rounded-3xl bg-gradient-to-r from-zinc-950/40 via-zinc-900 to-zinc-950/40 border border-zinc-700/30 text-center space-y-6 relative overflow-hidden">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <Link
            href="/trade"
            className="px-8 py-3.5 rounded-xl bg-zinc-500 hover:bg-zinc-400 text-zinc-950 font-bold text-sm shadow-xl shadow-zinc-700/20 transition-all duration-300"
          >
            Launch Dark Pool Terminal
          </Link>
          <Link
            href="/docs"
            className="px-8 py-3.5 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-white/10 text-white font-semibold text-sm transition-all"
          >
