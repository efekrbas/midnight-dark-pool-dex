...
export default function DocsPage() {
  ...
  return (
    <div className="min-h-screen py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-12 text-left relative">
      ...
      {/* Ambience glow */}
      <div className="absolute top-10 left-1/3 w-[600px] h-[300px] bg-zinc-500/10 rounded-full blur-[120px] pointer-events-none -z-10" />

      {/* HEADER */}
      <div className="border-b border-white/10 pb-8 space-y-3">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-500/10 border border-zinc-700/30 text-zinc-400 text-xs font-mono">
        ...
        <p className="text-zinc-300 text-sm sm:text-base max-w-3xl leading-relaxed font-light">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-3 space-y-2 sticky top-24">
          <p className="text-[11px] font-mono text-zinc-400 uppercase tracking-wider px-3 mb-2">
            Documentation Index
          </p>
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl font-mono text-xs transition-all ${
                  isActive 
                    ? 'bg-zinc-500/20 text-zinc-300 border border-zinc-700/40 font-bold shadow-lg shadow-zinc-700/10' 
                    : 'text-zinc-400 hover:text-white hover:bg-white/5 border border-transparent'
                }`}
              >
                <div className="flex items-center gap-2.5">
                  <Icon className={`w-4 h-4 ${isActive ? 'text-zinc-400' : 'text-zinc-500'}`} />
          ...
          <div className="pt-6 border-t border-white/10 mt-6 px-3 space-y-2">
            <p className="text-[11px] font-mono text-zinc-400 uppercase tracking-wider">Quick Links</p>
            <Link href="/about" className="text-xs text-zinc-400 hover:underline flex items-center gap-1 font-mono">
              About &amp; USP <ArrowRight className="w-3 h-3" />
            </Link>
            <Link href="/circuits" className="text-xs text-zinc-400 hover:text-white flex items-center gap-1 font-mono">
              Verified Circuits <ExternalLink className="w-3 h-3" />
            </Link>
            <a href="https://docs.midnight.network" target="_blank" rel="noopener noreferrer" className="text-xs text-zinc-400 hover:text-white flex items-center gap-1 font-mono">
        ...
        {/* MAIN CONTENT PANELS */}
        <div className="lg:col-span-9 space-y-8 bg-zinc-900/40 border border-white/10 rounded-3xl p-6 sm:p-10 backdrop-blur-xl min-h-[600px]">
          ...
          {activeSection === 'quickstart' && (
            <div className="space-y-8 animate-fadeIn">
              ...
              <div className="space-y-6 font-mono text-xs">
                ...
                {/* Step 1 */}
                <div className="p-5 rounded-2xl bg-zinc-950/60 border border-white/10 space-y-3">
                  <div className="flex items-center gap-3">
                    <span className="w-6 h-6 rounded-full bg-zinc-500/20 border border-zinc-700/40 text-zinc-400 font-bold flex items-center justify-center text-xs">
                      1
                    </span>
                  ...
                  <div className="pl-9 flex gap-3">
                    <a
                      ...
                      className="px-3 py-1.5 rounded-lg bg-zinc-500/10 border border-zinc-700/30 text-zinc-300 hover:bg-zinc-500/20 transition-all flex items-center gap-1.5"
                    >
                ...
                <div className="p-5 rounded-2xl bg-zinc-950/60 border border-white/10 space-y-3">
                  ...
                  <div className="pl-9 bg-black/40 p-3 rounded-xl border border-white/5 space-y-1">
                    <span className="text-zinc-500 text-[10px] uppercase">Preprod Network Configuration:</span>
                    <p className="text-zinc-300">RPC Endpoint: <code className="text-white">https://rpc.preprod.midnight.network</code></p>
                    <p className="text-zinc-300">Network ID: <code className="text-white">midnight-preprod</code></p>
                  </div>
                </div>
                ...
                <div className="p-5 rounded-2xl bg-zinc-950/60 border border-white/10 space-y-3">
                  ...
                  <p className="text-zinc-300 leading-relaxed pl-9">
                    Navigate to <Link href="/trade" className="text-zinc-400 underline">Trade Terminal</Link>. Select your trading pair (e.g. <code>NIGHT/tADA</code>), enter your limit price and size. 
          ...
          {activeSection === 'usp' && (
            <div className="space-y-8 animate-fadeIn">
              ...
              <div className="space-y-6 text-xs text-zinc-300 leading-relaxed">
                ...
                <div className="p-6 rounded-2xl bg-zinc-950/80 border border-zinc-700/30 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-mono text-[11px]">
                    <div className="p-4 rounded-xl bg-zinc-900 border border-white/5 space-y-1">
                      <span className="text-zinc-400 font-bold">1. Zero-Knowledge State Separation</span>
                      <p className="text-zinc-400">Order prices, volumes, and secret blinding factors exist solely in user local storage. Only cryptographic commitments (`amountCommitment`, `priceCommitment`) enter the Midnight ledger.</p>
                    </div>

                    <div className="p-4 rounded-xl bg-zinc-900 border border-white/5 space-y-1">
                      <span className="text-zinc-400 font-bold">2. Atomic Math Crossing Circuit</span>
                      <p className="text-zinc-400">Crossing is verified through ZK arithmetic constraints in `darkpool.compact`. The proof guarantees `buyPrice &gt;= sellPrice` without revealing the delta or absolute values.</p>
                    </div>

                    <div className="p-4 rounded-xl bg-zinc-900 border border-white/5 space-y-1">
                      <span className="text-zinc-400 font-bold">3. DUST Shielded Gas Token</span>
                      <p className="text-zinc-400">All transaction gas fees on Midnight are paid in DUST, breaking the transaction graph correlation that breaks anonymity on public networks.</p>
                    </div>

                    <div className="p-4 rounded-xl bg-zinc-900 border border-white/5 space-y-1">
                      <span className="text-zinc-400 font-bold">4. Selective Disclosure Viewing Keys</span>
                      <p className="text-zinc-400">Traders can prove compliance to auditors, tax authorities, or institutional risk desks without revealing secret trading algorithms to the market.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-8 animate-fadeIn">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
                  ...
                  <p className="text-zinc-400 text-sm mt-1">
                    Direct walkthrough of <code className="text-zinc-300">contracts/src/darkpool.compact</code>.
                  </p>
                </div>
                <button
                  onClick={() => copyCode(compactContractSnippet, 'compact')}
                  className="self-start sm:self-auto px-3 py-1.5 rounded-lg bg-zinc-950 border border-white/10 hover:border-white/20 text-xs font-mono text-zinc-300 flex items-center gap-1.5"
                >
                  {copiedSnippet === 'compact' ? <Check className="w-3.5 h-3.5 text-zinc-400" /> : <Copy className="w-3.5 h-3.5" />}
              ...
              <div className="space-y-4 font-mono text-xs">
                ...
                <div className="p-5 rounded-2xl bg-black border border-white/10 overflow-x-auto text-[11px] text-zinc-300 leading-relaxed">
                  <pre className="text-zinc-400 font-bold">// darkpool.compact - Core Circuit Definition</pre>
          ...
          {activeSection === 'compliance' && (
            <div className="space-y-8 animate-fadeIn">
              ...
              <div className="space-y-6 text-xs text-zinc-300 leading-relaxed font-mono">
                <p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  <div className="p-5 rounded-2xl bg-zinc-950/60 border border-zinc-700/20 space-y-2">
                    <span className="text-zinc-400 font-bold text-xs">Tax / PnL Exporter</span>
                  ...
                  <div className="p-5 rounded-2xl bg-zinc-950/60 border border-zinc-700/20 space-y-2">
                    <span className="text-zinc-400 font-bold text-xs">Proof of Non-Illicit Funds</span>
                    <p className="text-zinc-400 text-[11px]">
                  ...
                  <div className="p-5 rounded-2xl bg-zinc-950/60 border border-zinc-700/20 space-y-2">
                    <span className="text-zinc-400 font-bold text-xs">Auditor Viewing Key</span>
                    <p className="text-zinc-400 text-[11px]">
                ...
                <div className="p-5 rounded-2xl bg-zinc-950 border border-white/10 space-y-3">
                  ...
                  <p className="text-zinc-400 text-[11px]">
                    1. Go to <Link href="/certificate" className="text-zinc-400 underline">Compliance Certificate Portal</Link>.<br />
            ...
            <div className="space-y-8 animate-fadeIn">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
                  ...
                  <p className="text-zinc-400 text-sm mt-1">
                    Programmatic order placement using TypeScript and <code className="text-zinc-300">@midnight-ntwrk/compact-js</code>.
                  </p>
                </div>
                <button
                  ...
                  className="self-start sm:self-auto px-3 py-1.5 rounded-lg bg-zinc-950 border border-white/10 hover:border-white/20 text-xs font-mono text-zinc-300 flex items-center gap-1.5"
                >
                  {copiedSnippet === 'sdk' ? <Check className="w-3.5 h-3.5 text-zinc-400" /> : <Copy className="w-3.5 h-3.5" />}
              ...
              <div className="space-y-4 font-mono text-xs">
                ...
                <div className="p-5 rounded-2xl bg-black border border-white/10 overflow-x-auto text-[11px] text-zinc-300 leading-relaxed">
                  <pre className="text-zinc-400 font-bold">// TypeScript - Placing a Shielded Order via Midnight SDK</pre>
