...
export default function MEVSimulator() {
  ...
  return (
    <div className="w-full glass-panel p-6 sm:p-8 rounded-3xl border border-white/10 shadow-2xl bg-zinc-900/80 backdrop-blur-xl relative overflow-hidden">
      {/* Background Orbs */}
      <div className="absolute top-0 right-0 w-72 h-72 bg-zinc-600/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-72 h-72 bg-zinc-700/10 rounded-full blur-3xl pointer-events-none" />

      <div className="max-w-4xl mx-auto space-y-8 relative z-10">
        
        {/* Header */}
        <div className="text-center space-y-3">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-500/10 border border-zinc-700/30 text-zinc-300 text-xs font-mono">
          ...
          <p className="text-sm text-zinc-300 max-w-2xl mx-auto font-light">
        ...
        <div className="p-6 rounded-2xl bg-zinc-950/80 border border-white/10 space-y-4">
          <div className="flex justify-between items-center text-xs font-mono">
            <span className="text-zinc-400">Simulated Block Order Size:</span>
            <span className="text-xl font-extrabold text-zinc-400 font-sans">
          ...
          <input
            ...
            className="w-full h-2.5 bg-zinc-800 rounded-lg appearance-none cursor-pointer accent-zinc-500"
          />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-red-950/20 border border-red-500/30 text-left space-y-4 relative overflow-hidden group">
            ...
            <div className="space-y-3 font-mono text-xs">
              ...
              <div className="flex justify-between">
                <span className="text-zinc-400">Front-running Risk:</span>
                <span className="text-red-400 font-bold">Extremely High</span>
              </div>
              <div className="flex justify-between">
                <span className="text-zinc-400">Estimated Slippage Impact:</span>
              ...
              <div className="pt-2 border-t border-red-500/20 flex justify-between items-center">
                <span className="text-zinc-300 font-sans font-semibold">MEV & Bot Extraction Loss:</span>
          ...
          <div className="p-6 rounded-2xl bg-zinc-950/20 border border-zinc-700/40 text-left space-y-4 relative overflow-hidden shadow-[0_0_30px_rgba(161,161,170,0.15)]">
            <div className="flex items-center justify-between border-b border-zinc-700/20 pb-3">
              <div className="flex items-center gap-2 text-zinc-400 font-bold text-base">
                <ShieldCheck className="w-5 h-5" />
                <span>Midnight Dark Pool (ZK-SNARK)</span>
              </div>
              <span className="px-2 py-0.5 rounded text-[10px] font-mono bg-zinc-500/20 text-zinc-300 border border-zinc-700/30">
                100% IMMUNE
              </span>
            </div>
            ...
            <div className="space-y-3 font-mono text-xs">
              <div className="flex justify-between">
                <span className="text-zinc-400">Visibility:</span>
                <span className="text-zinc-400 font-bold">Cryptographically Masked</span>
              </div>
              <div className="flex justify-between">
                <span className="text-zinc-400">Front-running Risk:</span>
                <span className="text-zinc-400 font-bold">Zero (MEV Shielded)</span>
              </div>
              <div className="flex justify-between">
                <span className="text-zinc-400">Slippage Impact:</span>
                <span className="text-zinc-400">0.00%</span>
              </div>
              <div className="pt-2 border-t border-zinc-700/20 flex justify-between items-center">
                <span className="text-zinc-300 font-sans font-semibold">MEV Extraction Loss:</span>
